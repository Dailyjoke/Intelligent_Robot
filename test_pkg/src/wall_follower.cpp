//Gazebo : Turtlebot3_Worldwall_follower雷射巡檢節點練習
//https://github.com/jeromy-lin/intelligence_robot/tree/main/test_pkg/src
#include <ros/ros.h>
...
double g_safety_distance = 0.5; //global detection distance
double g_forward_speed = 0.5; //global forward speed
double g_turn_speed = 0.5; //global turn speed
double g_back_speed = -0.3; //global back speed
...
void rotate90Degrees(){
    ...
    // stop rotation & reset obstacle flag
    g_twist.angular.z = 0.0;
    g_cmd_vel_pub.publish(g_twist);
